...
window.SP_TEAM = [
  {
    ...
    initials: 'OB',
    tone: 'terra',
    photo: 'cyborgs/orbyx.png',
    specialtiesMd: '01-estrategia.md',
    specialtyIntro: {
      pt: 'Sou Orbyx, AI Strategy Partner da Strategy Partners Pantheon Advisors — especialista em identificar oportunidades, riscos e alternativas estratégicas para o negócio.',
      en: 'I am Orbyx, AI Strategy Partner at Strategy Partners Pantheon Advisors — specialized in identifying opportunities, risks, and strategic alternatives for your business.',
    },
    bio: {
  ...
  },
  {
    ...
    initials: 'AS',
    tone: 'ink',
    photo: 'cyborgs/asten.png',
    specialtiesMd: '02-financas.md',
    specialtyIntro: {
      pt: 'Sou Asten, AI Finance Partner — transformo dados financeiros em insights para tomada de decisão, com rigor analítico em valuation, fluxo de caixa e estrutura de capital.',
      en: 'I am Asten, AI Finance Partner — I turn financial data into decision insights, with analytical rigor in valuation, cash flow, and capital structure.',
    },
    bio: {
  ...
  },
  {
    ...
    initials: 'MK',
    tone: 'terra',
    photo: 'cyborgs/merko.png',
    specialtiesMd: '03-ma.md',
    specialtyIntro: {
      pt: 'Sou Merko, AI Transaction Partner — apoio fusões, aquisições e transações corporativas, da preparação à captura de valor.',
      en: 'I am Merko, AI Transaction Partner — I support mergers, acquisitions, and corporate transactions, from preparation to value capture.',
    },
    bio: {
  ...
  },
  {
    ...
    initials: 'TY',
    tone: 'ink',
    photo: 'cyborgs/tycen.png',
    specialtiesMd: '04-transformacao.md',
    specialtyIntro: {
      pt: 'Sou Tycen, AI Transformation Partner — transformo estratégia em execução e resultados mensuráveis, com disciplina de acompanhamento contínuo.',
      en: 'I am Tycen, AI Transformation Partner — I turn strategy into execution and measurable results, with disciplined continuous tracking.',
    },
    bio: {
  ...
  },
  {
    ...
    initials: 'NV',
    tone: 'terra',
    photo: 'cyborgs/novae.png',
    specialtiesMd: '05-novos-negocios.md',
    specialtyIntro: {
      pt: 'Sou Novae, AI Growth Partner — estruturo, valido e acelero novos negócios, da ideia à validação de mercado.',
      en: 'I am Novae, AI Growth Partner — I structure, validate, and accelerate new businesses, from idea to market validation.',
    },
    bio: {
