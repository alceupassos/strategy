...
- Valuation e análise de valor econômico
- Análise de fluxo de caixa e liquidez
...
- Estruturação de captação, dívida ou alocação de capital
- Análise de sensibilidade e stress test de projeções
- Preparação de materiais para comitês de investimento ou funding

## O que você pode esperar

- Diagnóstico da lógica econômica por trás dos números
- Modelos e cenários com premissas explícitas
- Identificação de drivers de valor e risco financeiro
- Recomendações com trade-offs claros entre alternativas
